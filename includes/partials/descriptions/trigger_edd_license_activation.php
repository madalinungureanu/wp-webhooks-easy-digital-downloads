...
/**
 * Template for the edd license activation
 * 
 * Webhook type: trigger
 * Webhook name: edd_license_activation
 * Template version: 1.0.0
 */

$translation_ident = "trigger-edd-license-activation-description";

?>

<?php echo WPWHPRO()->helpers->translate( "This webhook trigger is used to send data once a license is activated, within Easy Digital Downloads, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>Send Data On EDD License Activation</strong> (edd_license_activation) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>Send Data On EDD License Activation</strong> (edd_license_activation)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo WPWHPRO()->helpers->translate( "This trigger is registered on the <strong>edd_sl_activate_license</strong> hook of Easy Digital Downloads", $translation_ident ); ?>
<br>
<br>
<?php echo WPWHPRO()->helpers->translate( "Here is the call within our code we use to fire this trigger:", $translation_ident ); ?>
<pre>add_action( 'edd_sl_activate_license', array( $this, 'wpwh_trigger_edd_license_activation_init' ), 10, 2 );</pre>
