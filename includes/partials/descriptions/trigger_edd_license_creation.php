...
/**
 * Template for the edd license creation
 * 
 * Webhook type: trigger
 * Webhook name: edd_license_creation
 * Template version: 1.0.0
 */

$translation_ident = "trigger-edd-license-creation-description";
...
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>Send Data On EDD License Creation</strong> (edd_license_creation) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>Send Data On EDD License Creation</strong> (edd_license_creation)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo WPWHPRO()->helpers->translate( "This trigger is registered on the <strong>edd_sl_store_license</strong> hook of Easy Digital Downloads", $translation_ident ); ?>
<br>
<br>
<?php echo WPWHPRO()->helpers->translate( "Here is the call within our code we use to fire this trigger:", $translation_ident ); ?>
<pre>add_action( 'edd_sl_store_license', array( $this, 'wpwh_trigger_edd_license_creation_init' ), 10, 4 );</pre>
