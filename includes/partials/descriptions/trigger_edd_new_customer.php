...
/**
 * Template for the edd customer creation
 * 
 * Webhook type: trigger
 * Webhook name: edd_new_customer
 * Template version: 1.0.0
 */

$translation_ident = "trigger-edd-new-customer-description";

?>

<?php echo WPWHPRO()->helpers->translate( "This webhook trigger is used to send data, on creation of a customer, within Easy Digital Downloads, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo WPWHPRO()->helpers->translate( "This description is uniquely made for the <strong>Send Data On EDD New Customer</strong> (edd_new_customer) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo WPWHPRO()->helpers->translate( "How to use <strong>Send Data On EDD New Customer</strong> (edd_new_customer)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo WPWHPRO()->helpers->translate( "This trigger is registered on the <strong>edd_customer_post_create</strong> hook of Easy Digital Downloads", $translation_ident ); ?>
<br>
<br>
<?php echo WPWHPRO()->helpers->translate( "Here is the call within our code we use to fire this trigger:", $translation_ident ); ?>
<pre>add_action( 'edd_customer_post_create', array( $this, 'ironikus_trigger_edd_new_customer' ), 10, 2 );</pre>
