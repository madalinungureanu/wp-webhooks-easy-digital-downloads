...
/**
 * Template for the edd license status update
 * 
 * Webhook type: trigger
 * Webhook name: edd_license_status
 * Template version: 1.0.0
 */

$translation_ident = "trigger-edd-license-upate-description";
...
<pre>add_action( 'edd_sl_post_set_status', array( $this, 'wpwh_trigger_edd_license_status_init' ), 10, 2 );</pre>
